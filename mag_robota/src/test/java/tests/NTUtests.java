...
public class NTUtests extends WebBrowserSettings {
    //1
    @Test
    ...
    public void FooterMenu() {
        ...
        driver.get(ConfigProvider.BASE_URL);
        main.maxSize();
        main.getPidrozdilyOpen();
        String URL = driver.getCurrentUrl();
        Assert.assertEquals(URL, ConfigProvider.FINAL_P);
    }
    @Test
    public void Header() {
        Main main = PageFactory.initElements(driver, Main.class);
        driver.get(ConfigProvider.BASE_URL);
        main.maxSize();
        By findButton = By.xpath("//*[@id=\"main-header\"]/div/div/div[2]/div");
        String color = driver.findElement(findButton).getCssValue("color");
        String c = Color.fromString(color).asHex();
        Assert.assertEquals(c, ConfigProvider.FINAL_COLOR);
    }
    @Test
    public void menu() {
        Main main = PageFactory.initElements(driver, Main.class);
        driver.get(ConfigProvider.BASE_URL);
        main.maxSize();
        main.getUniversityOpen();
        String URL = driver.getCurrentUrl();
        Assert.assertEquals(URL, ConfigProvider.FINAL_BANK);
    }
    @Test
    public void Partners() {
        ...
        main.getHEOpen();
        String URL = driver.getCurrentUrl();
        Assert.assertEquals(URL, ConfigProvider.FINAL_PARTNERS);
    }
    @Test
